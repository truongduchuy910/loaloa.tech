...
function Index(_ref) {
  ...
  var _useState8 = Object(react__WEBPACK_IMPORTED_MODULE_2__["useState"])("Nhấn chọn để báo giá!"),
      guide = _useState8[0],
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            if (!(designs_id.length && settings_id.length)) {
              _context.next = 23;
              break;
            }

            console.log(designs_id, settings_id);
            _context.next = 10;
  ...
  return __jsx(_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_10__["default"], {
    ...
    __self: this
  }, guide), __jsx(_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_11__["default"], {
    variant: "body1",
    color: "primary",
    align: "center",
    __source: {
...
//# sourceMappingURL=index.js.c32d3bc7d9975b395755.hot-update.js.map